package com.tts.swagger.practice.config;
...
public class SwaggerConfig {
    ...
    private ApiInfo buildApiInfoV2() {
        return new ApiInfoBuilder()
                ...
                .version("2.0.0")
                .contact(new Contact("Randy Roberson", "Rand.works", "roberson@randy.works"))
    ...
    public Docket api() {
        return new Docket(DocumentationType.SWAGGER_2)
                .select()
                .apis(RequestHandlerSelectors.basePackage("com.tts.swagger"))
