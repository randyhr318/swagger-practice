package com.tts.swagger.practice.controller;

import com.tts.swagger.practice.model.ItemV2;
...
public class ItemControllerV2 {
    ...
    @ApiResponses( value = {
            ...
            @ApiResponse(code = 401, message = "You are authorized to view the menu")
    })
